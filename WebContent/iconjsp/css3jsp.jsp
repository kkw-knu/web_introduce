...
<body>
	<div>
		...
		<main>
			...
			<div class="big">
				<div class="small">
					<img src="../css/tech-icons/css3image.png" alt="css3"> <br>
					<h2 class="textcsenter">Css</h2>
					<br>
					<p>캐스케이딩 스타일 시트(Cascading Style Sheets, CSS)</p>
					<br>
					<p>html로 작성한 파일이 표시되는 방법을 기술하는 언어</p>
					<br>
				</div>
				<div
