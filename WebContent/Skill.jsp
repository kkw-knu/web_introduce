...
<link href="css/skillmain.css" rel="stylesheet" type="text/css">
<link rel="preconnect" href="https://fonts.gstatic.com">
		...
		<main>
			...
			<div class="maintechbox_2">
				<div class="techimage" onclick="location='iconjsp/gitjsp.jsp'">
					<img src="css/tech-icons/gitimage.png" alt="Git">
					<div>Git</div>
				</div>
				...
				<progress max="100" value="40" class="probar"></progress>
				<div class="techimage" onclick="location='iconjsp/praclejsp.jsp'">
			...
			<div style="width: 1000;">
				<div class="workbox">
					<article class="imagebox"
						onclick="location='projectjsp/homepagejsp.jsp'">
						<img src="css/homepage.PNG" alt="homepage make">
						<h2>나만의 홈페이지만들기</h2>
						<p>개인만의 포트폴리오 공간</p>
					</article>
					<article class="imagebox"
