...
<html>
    ...
    <style>
		...
		<link href="/web/css/Aboutmain.css" rel="stylesheet" type="text/css">
		<link rel="preconnect" href="https://fonts.gstatic.com">
		...
		<div>
			...
			<main>
				...
				<div>
					...
					<h2 class="abouttitle">알고리즘 문제의 개념과 풀이
						<small>배우고 있지만 자신있습니다.</small>
					</h2>
					<ul class="superlist">
						<li>제 능력중 가장 <b>뛰어난</b> 부분이라고 생각합니다.</li>
						<ui class="childlist">
					...
					<h2 class="abouttitle">프론트엔드(Front End) 개발
						<small>배워가고 있습니다.</small>
					</h2>
					<ul class="superlist">
					...
					<h2 class="abouttitle">백엔드(Back End) 개발
						<small>배워가고 있습니다.</small>
					</h2>
					<ul class="superlist">
						...
						<li>현재 <b>국비지원 프로그램</b>으로 학원에서 교육받고있습니다.</li>
					</ul>
					<div class="maintechbox_2">
